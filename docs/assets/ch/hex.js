...
function newGame(){
  ...
  game.turn = game.first; game.over = false; game.busy = false; game.hint = -1; game.last = -1; game.hintUsed = false; game.bridged = false; game.log = []; game.id++;
...
async function roboMove(){
  ...
  if (id !== game.id || game.over) return;   // or while it was thinking
  game.lastThink = th;
