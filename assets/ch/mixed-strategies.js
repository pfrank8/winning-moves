...
function chart(){
  ...
  const W = 520, H = 260, ox = 46, oy = 14, cw = 440, ch = 200;
  ...
  s += `<text x="${X(0) + 8}" y="${Y(L(0)) - 8}" fill="var(--robo)">Robo dives Left</text><text x="${X(0) + 8}" y="${Y(R(0)) - 8}" fill="var(--robo)">Robo dives Right (dashed)</text>`;
